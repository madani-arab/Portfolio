  ...
  return (
    ...
    className="section">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            ...
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col  md:grid-cols-2 md:gap-2  ">
            ...
            <form 
            action="https://getform.io/f/agdjznyb" 
            method="POST"
            ...
            >
                ...
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    <div className="mb-4  ">
                        ...
                        autoComplete="name"
                        required
                        placeholder="Abdirahman Abdikadir" 
                    ...
                    <div className="mb-4">
                        ...
                        autoComplete="email"
                        required
                        placeholder="abdirahman@email.com" 
                        className="text-field reveal-up"
                        id="email" 
                        />
                    </div>
                ...
                <div className="mb-4 ">
                    ...
                    placeholder="Hi!"
                    required
                    className="text-field resize-y min-h-32 max-h-80 p-2 reveal-up"
                    >
